...
static PLAY_HANDLE init_play_handle(int is_playback){
	...
	/* 192.168.42.2 */
	res->user_handle = hwnet_login("192.168.42.2",5198,"admin","12345");
...
static void create_resource(int is_playback,JNIEnv *env, jobject obj)
{
  /* make sure init once */
...
JNIEXPORT void JNICALL Java_com_howell_camera_HWCameraActivity_display
(JNIEnv *env, jobject obj, jint is_playback){
	create_resource(is_playback,env,obj);
}
...
//����ʼʱ�ж��Ƿ�ڰ�ģʽ
JNIEXPORT int JNICALL Java_com_howell_camera_HWCameraActivity_setBlackWhiteMode
(JNIEnv *env, jclass cls){
	...
	setFirstColorMode(bw.blackwhite);
	return bw.control_mode;//0�ֶ� 1�Զ�
}
...
JNIEXPORT int JNICALL Java_com_howell_camera_HWCameraActivity_setFirstColorMode
(JNIEnv *env, jclass cls){
	return res->color_mode;//0-��ɫ 1-�ڰ�
}

//����ʼʱ�жϺ��⼤���Ƿ���
JNIEXPORT int JNICALL Java_com_howell_camera_HWCameraActivity_setLaserIrradiateMode
(JNIEnv *env, jclass cls){
...
//����ʼʱ�ж��ƶ�����Ƿ���
JNIEXPORT int JNICALL Java_com_howell_camera_HWCameraActivity_setVMDMode
(JNIEnv *env, jclass cls){
