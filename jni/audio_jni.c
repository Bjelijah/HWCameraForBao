...
JNIEXPORT void JNICALL JNICALL Java_com_howell_camera_HWCameraActivity_nativeAudioInit
...
JNIEXPORT void JNICALL JNICALL Java_com_howell_camera_HWCameraActivity_nativeAudioStop
(JNIEnv *env, jclass cls)
{
  audio_stop();
}

JNIEXPORT void JNICALL JNICALL Java_com_howell_camera_HWCameraActivity_nativeAudioDeinit
(JNIEnv *env, jobject obj)
{
  /* TODO */
